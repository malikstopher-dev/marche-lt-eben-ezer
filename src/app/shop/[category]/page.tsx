...
const departmentSlugs: Record<string, string> = {
  ...
  "legumes": "Produce & Greens",
  "greens": "Produce & Greens",
  "snacks": "Snacks",
  "cosmetics": "Cosmetics",
...
const slugToDepartment: Record<string, string> = departmentSlugs;

const categoryNames: Record<string, string> = {
  "pantry": "Épicerie Africaine",
  "epicerie": "Épicerie Africaine",
  "food": "Épicerie Africaine",
  "frozen": "Poissons & Surgelés",
  "surgeles": "Poissons & Surgelés",
  "beverages": "Boissons",
  "boissons": "Boissons",
  "drinks": "Boissons",
  "produce": "Légumes & Feuilles",
  "legumes": "Légumes & Feuilles",
...
function CategoryShopContent() {
  ...
  const categoryId = slugToDepartment[categorySlug] || categoryParam;
  ...
  const categoryName = categoryNames[categorySlug] || categoryParam || "Produits";
